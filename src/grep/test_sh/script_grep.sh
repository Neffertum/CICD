...
SUCCESS=0
FAIL=0
FILE_NAME="src/grep/files/bethoven9.txt"
PATTERN="-e D"
REGEX="D?"
DIFF_OUTPUT=""
echo "Testing grep with pattern $PATTERN..."
for flag_1 in '' -i -c -h -s -o
do
    for flag_2 in '' -i -c -h -s -o
    do
        for flag_3 in '' -i -c -h -s -o
        do
            for flag_4 in '' -i -c -h -s -o
            do
                ...
                then
                    ...
                    ./src/grep/s21_grep $OPTIONS > s21_temp.txt
